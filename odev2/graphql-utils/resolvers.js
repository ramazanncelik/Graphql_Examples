...
const resolvers = {
    ...
    Mutation: {
        // User ---------------------------------------
        addUser: (parent, args) => {
            const newUser = { id: (users.length + 1), ...args.data }
            users.push(newUser);
            return newUser;
        },
        ...
        addEvent: (parent, args) => {
            const newEvent = { id: (events.length + 1), ...args.data }
        ...
        addLocation: (parent, args) => {
            const newLocation = { id: (locations.length + 1), ...args.data }
        ...
        addParticipant: (parent, args) => {
            const newParticipant = { id: (participants.length + 1), ...args.data }
